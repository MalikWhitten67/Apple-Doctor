        ...
        <div className="mt-8 mb-16">
            <div className="card mt-2  border">
                ...
                <div className="card-body">
                    ...
                    <p className="text-sm">
                        Enter patient complications ie: symtoms, pain ratio, etc and we will try to diagnose them.
                    </p>


                    <textarea className="textarea h-24  resize-none textarea-bordered w-full" placeholder="Enter Data seperated by a comma name, age,symtoms given"></textarea>
                    {
