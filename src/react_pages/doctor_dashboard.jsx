...
export default function Dashboard() {
  ...
  useEffect(() => {
    if (!api.authStore.model.isDoctor) window.location.href = "/dash_user";
    ...
    <div className=" p-2 font-sans xl:w-[30vw] xl:justify-center xl:mx-auto lg:w-[30vw] lg:justify-center lg:mx-auto ">
      ...
      <div className="mt-8 mb-16">
        <div className="card mt-2  border">
          <div className="card-body">
            ...
            <p className="text-sm">
              Enter patient symptoms and we will give you an diagnosis of the
              possible illness or disease they may have
            </p>
            <div className="relative">
              <textarea
                ...
                placeholder="Enter Symptoms: e.g. headache, pain under rib, fever body over 103 degrees, trouble sleeping"
      ...
      <dialog ref={outputRef} className="modal">
        <div className=" bg-white flex-col gap-5   xl:modal-box lg:modal-box   p-5 xl:w-[30vw] xl:justify-center xl:mx-auto lg:w-[30vw] lg:justify-center lg:mx-auto  h-screen  overflow-x-auto ">
          ...
          <div className="flex flex-col text-md font-sans mt-8 "></div>
          <div className="card w-full p-0 bg-base-100  mt-8">
            ...
            <div className="  mt-8 flex flex-col gap-2">
              ...
              <div className="flex">
                <p className="font-normal text-md">{ai_output?.description}</p>
              </div>
              ...
              <label className="mt-2">Known Common Symptoms:</label>
